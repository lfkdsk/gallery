...
$('img')
  .not(
    'footer .leaflet-marker-icon, img,.drawer-img, .mdui-card-header-avatar,.itp-mag-content img,.itp-post-author-avatar img,.itp-post-gallery img,.vavatar img,.nofancy'
  )
  .each(function () {
